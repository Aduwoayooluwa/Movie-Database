...
const Menubar = (props: Props) => {    
    return (
        <div className='bg-slate-900'>
            ...
            <SwiperSlide ><p  className={`p-2  cursor-pointer text-center shadow text-sm hover:bg-slate-500 border border-slate-50 rounded-md `}><a href='/'>Home</a></p></SwiperSlide>
                <SwiperSlide ><p  className={`p-2  cursor-pointer text-center shadow text-sm hover:bg-slate-500 border border-slate-50 rounded-md `}><a href='/movies'>Movies</a></p></SwiperSlide>
