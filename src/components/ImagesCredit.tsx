...
const ImagesCreditData = ({ data, category }: Props) => {
                    ...
                    <SwiperSlide key={index} className='shadow rounded-md'>
                        <a href={`/${category}/${item.id}`}>
                            <div  className='my-4 p-2 '>
                                <img loading='lazy' className="rounded" src={`https://image.tmdb.org/t/p/w500/${item.file_path || item.profile_path || item.postal_path}`} alt="images" />
...
export default ImagesCreditData